...
- **Justification** : Si vous choisissez de travailler sur un projet personnalisé (différent de GanttProject), vous devez motiver ou expliquer pourquoi ce projet vous permettrait de démontrer vos compétences en réingénierie.
...
<p align="center">
  <img src="figs/refactoring.jpeg?raw=true" alt="Refactoring" style="width:200px;height:300px;"/>
</p>
